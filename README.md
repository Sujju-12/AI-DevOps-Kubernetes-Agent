...
**Local-only runtime:** this project does not use InsForge, OpenRouter, or other cloud providers. Auth and history live in SQLite. Reasoning uses a local SRE engine (optional Ollama). Clusters come from your machine kubeconfig; if that file is missing, the UI shows built-in demo clusters.
