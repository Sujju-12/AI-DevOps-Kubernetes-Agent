"""Offline investigation samples used when DEMO_MODE=true or kubectl is unavailable."""

from copy import deepcopy


def demo_investigation(scenario: str | None = None) -> dict:
    scenario = (scenario or "crashloop").lower()
    fixtures = {
        "crashloop": CRASHLOOP,
        "imagepull": IMAGEPULL,
        "oom": OOM,
    ...
    return deepcopy(fixtures.get(scenario, CRASHLOOP))
        ...
        "findings": [
            {
                "reason": "BackOff",
                "type": "Warning",
                "message": "Back-off restarting failed container payment in pod payment-service-7b9c",
                "namespace": "demo",
                "object": "Pod/payment-service-7b9c",
                "count": 8,
            }
        ],
    },
...
IMAGEPULL = {
    ...
    "events": {
        "warning_count": 1,
        "detected": ["FailedPull", "ErrImagePull"],
        "findings": [
            {
                "reason": "FailedPull",
                "type": "Warning",
                "message": "Failed to pull image 'nginx:this-tag-does-not-exist'",
                "namespace": "demo",
                "object": "Pod/checkout-0",
                "count": 3,
            }
        ],
    },
        ...
        "pod_logs": [
            {
                ...
                "status": "OOMKilled",
                "has_errors": True,
                "excerpt": "Killed process due to OOM",
            }
        ],
    },
